class ZodiacController < ApplicationController
  def ram
    ...
    render("/horoscopes/ram.html.erb")
  end
  ...
  def bull
    ...
    render("/horoscopes/bull.html.erb")
  end
  ...
  def twins
    ...
    render("/horoscopes/twins.html.erb")
  end
  ...
  def crab
    ...
    render("/horoscopes/crab.html.erb")
  end
  ...
  def lion
    ...
    render("/horoscopes/lion.html.erb")
  end
  ...
  def maiden
    ...
    render("/horoscopes/maiden.html.erb")
  end
  ...
  def scales
    ...
    render("/horoscopes/scales.html.erb")
  end
  ...
  def scorpion
    ...
    render("/horoscopes/scorpion.html.erb")
  end
  ...
  def archer
    ...
    render("/horoscopes/archer.html.erb")
  end
  ...
  def goat
    ...
    render("/horoscopes/goat.html.erb")
  end
  ...
  def waterbearer
    ...
    render("/horoscopes/waterbearer.html.erb")
  end
  ...
  def fish
    ...
    render("/horoscopes/fish.html.erb")
  end
end
